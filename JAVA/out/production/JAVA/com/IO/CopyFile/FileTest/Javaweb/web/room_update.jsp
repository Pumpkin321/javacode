...
<div class="logDiv">
    ...
    <div class="banner-text">
        <form class="form-inline" name="myForm" action="RoomServlet?method=update_Room" method="post">
            <div class="best-hot"style="float: right;margin-left: -100px;margin-right: 200px;margin-top: 50px;">
                ...
                <tr>
                    <div class="lgD">
                        <img class="img1" src="images/位置（指南针）.png" /><input type="text" id="room_loc" name="room_loc" value="${room.room_loc}"
                                                                   placeholder="输入房间位置"/>
                    </div>
                </tr>
                <tr>
                ...
                <tr>
                    房间状态：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="room_state" id="room_state" value="${room.room_state}">
