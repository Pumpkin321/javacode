...
<div class="logDiv">
    ...
    <div class="banner-text">
        <form class="form-inline" name="myForm" action="EquimentServlet?method=update_Equiment" method="post">
            <div class="best-hot"style="float: right;margin-left: -100px;margin-right: 200px;margin-top: 50px;">
                ...
                <div class="lgD">
                    <img class="img1" src="images/酒店.png" /><input type="text" id="equ_id" name="equ_id"
                                                                   placeholder="器材序号" value="${equiment.equ_id}"/>
                </div></tr>
                <tr>
                    <div class="lgD">
                        <img class="img1" src="images/位置（指南针）.png" /><input type="text" id="equ_name" name="equ_name" value="${equiment.equ_name}"
                                                                            placeholder="输入器材名字"/>
                    </div></tr><tr>
                <tr>
                    器材类型：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="equ_type" id="equS_type" value="${equiment.equ_type}">
                ...
                <tr>
                    <div class="lgD">
                        <img class="img1" src="images/酒店.png" /><input type="text" id="equ_num" name="equ_num"
                                                                       placeholder="输入器材数量" value="${equiment.equ_num}"/>
                    </div></tr><tr>
                <div class="lgD">
                    <img class="img1" src="images/价格.png" /><input type="text" id="equ_remark" name="equ_remark" value="${equiment.equ_remark}"
                                                                   placeholder="输入器材备注" />
                </div></tr>
                <tr>
                <div class="lgD">
                    <img class="img1" src="images/价格.png" /><input type="text" id="equ_explain" name="equ_explain" value="${equiment.equ_explain}"
                                                                   placeholder="输入器材说明" />
                </div></tr>
                <tr>
                    <div class="lgD">
                        <img class="img1" src="images/价格.png" /><input type="text" id="equ_picpath" name="equ_picpath" value="${equiment.equ_picpath}"
                                                                       placeholder="输入器材展示" />
                    </div></tr>
                <tr>
                    <div class="lgD">
                        <img class="img1" src="images/价格.png" /><input type="text" id="emp_id" name="emp_id" value="${equiment.emp_id}"
                                                                       placeholder="输入器材维修人员id" />
                    </div></tr>
                <tr>
                    <div class="logC">${result}
